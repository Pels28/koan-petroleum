        ...
        <section className="font-montserrat">
              ...
              {featuredNews.map((news, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <Button color="primary" variant="light" size="lg" radius="md" className="" endContent={<FaArrowRightLong/>}>
                      Read Full Story
                    </Button>
                  </div>
                </motion.div>
          ...
          <div className="bg-primary-50 py-16">
            <div className="container mx-auto px-6">
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <Button color="primary" size="lg" radius="md" variant="light" className="">
                          Read More
                        </Button>
                      </div>
                    </div>
              ...
              >
                <Button color="primary" size="lg" className="px-6 py-3" endContent={<IoNewspaper/>}>
                  View All News
                </Button>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {upcomingEvents.map((event, index) => (
                ...
                >
                  ...
                  <Button size="lg" radius="md" variant="light" color="primary" className="">
                    Learn More & Register
                  </Button>
                </motion.div>
              ))}
            ...
            <div className="w-full px-auto">
              {[
                ...
                >
                  ...
                  <Button color="primary" variant="light" size="lg" radius="md" className="text-primary">
