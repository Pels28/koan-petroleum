...
const CareersContent = () => {
  ...
  return (
    <section className="font-montserrat">
      <div className="relative w-full h-[450px] bg-careersOverlay bg-center bg-cover bg-no-repeat flex items-center justify-center">
        <motion.div
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
            ...
            {[
              {
                icon: (
                  ...
                  // <TbStarsFilled className="w-16 h-16 text-primary"/>
                ),
              ...
              <div
                key={index}
                className="relative h-80 bg-tertiary rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group border border-gray-200 hover:border-primary/30"
              >
                {/* Static Content */}
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-center bg-white transform translate-x-full group-hover:translate-x-0 transition-all duration-500">
          ...
          <div
            ref={statsRef}
            className="bg-primary rounded-2xl p-8 md:p-12 border border-primary/10"
          >
                ...
                {[
                  {
                    ...
                    icon: (
                      <FaCalendarAlt className="w-12 h-12 text-white mb-4" />
                    ),
                  },
                  {
                    number: `${stationsCount.toLocaleString()}+`,
                    label: "Fuel stations nationwide",
                    icon: <FaGasPump className="w-12 h-12 text-white mb-4" />,
                  },
                  {
                    number: `${customersCount.toLocaleString()}+`,
                    label: "Employees across Ghana",
                    icon: <FaUsers className="w-12 h-12 text-white mb-4" />,
                  }
                ].map((stat, index) => (
                  <div
                    key={index}
      ...
      {/* Current Openings */}
      <section id="openings" className="p-10">
        <div className="mx-auto">
          ...
          <Accordion
            ...
            className="gap-4" // Adds spacing between accordion items
            itemClasses={{
              base: "py-0 w-full",
              title: "font-semibold text-lg",
              trigger:
                "px-6 py-4 hover:bg-primary/10 rounded-lg transition-colors",
              content: "px-6 pb-6",
          ...
          >
            <AccordionItem
              ...
              classNames={{
                title: "text-primary-dark", // Slightly darker primary color for text
                trigger: "", // Lighter hover effect
              }}
            >
              <div className="space-y-4">
                <div className="p-4 border border-primary/20 rounded-lg bg-primary/5">
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="font-bold text-lg">Mechanical Engineer</h4>
            ...
            >
              <div className="p-4 border border-primary/20 rounded-lg bg-primary/5">
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="font-bold text-lg">Station Manager</h4>
                    <div className="flex flex-wrap gap-2 mt-2">
                      <span className="px-2 py-1 text-xs rounded-full bg-primary/10 text-primary">
                        Takoradi
                      </span>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-20">
          <h2 className="text-5xl font-bold mb-6 text-primary">
            Your Questions
            <span className="block text-gray-900 mt-2">Answered</span>
          </h2>
          <div className="w-24 h-1.5 bg-primary mx-auto rounded-full"></div>
        </div>
        ...
        <div className="space-y-6">
          {[
            ...
            },
            {
              ...
              answer: "Most roles are on-site, but some corporate positions allow hybrid work.",
            },
            {
              question: "What benefits do you offer?",
              answer: "We provide health insurance, performance bonuses, training programs, and retirement benefits.",
            },
            {
              question: "Do you offer internships or graduate programs?",
              answer: "Yes, we have annual internship programs and occasionally run graduate trainee initiatives.",
            },
          ].map((faq, index) => (
            <Accordion 
              key={index} 
              ...
              itemClasses={{
                ...
                trigger: "px-6 py-4 bg-white hover:bg-gray-50",
                title: "text-lg font-medium flex items-center",
                content: "px-6 pb-4 text-gray-600",
                indicator: "text-primary"
              }}
            >
              <AccordionItem
                ...
                title={
                  <div className="flex items-center">
                    <div className="w-8 h-8 mr-4 rounded-full bg-gradient-to-b from-primary to-secondary flex items-center justify-center text-white text-sm font-bold">
                      {index + 1}
                    </div>
                    {faq.question}
                  </div>
        ...
        {/* Decorative elements */}
        <div className="absolute left-10 top-1/4 w-32 h-32 rounded-full bg-primary/10 blur-3xl -z-10"></div>
        <div className="absolute right-10 bottom-1/4 w-40 h-40 rounded-full bg-secondary/10 blur-3xl -z-10"></div>
      </div>
    </section>
